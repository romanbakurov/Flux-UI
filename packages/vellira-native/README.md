...
This package contains iOS-inspired native components built with React Native `StyleSheet`. Components use shared colors, typography, spacing, and radius from `@romanbakurov/vellira-tokens`, shared behavior from `@romanbakurov/vellira-core`, and renderer-neutral contracts from `@romanbakurov/vellira-types`.
